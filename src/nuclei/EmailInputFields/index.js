...
export default withStyles(styles)(EmailInputFields);
...
class BaseEmailInputField extends React.Component<
  { ...$Exact<EmailInputFieldsProps>, label: string },
...
const EmailInputField = withStyles(styles)(BaseEmailInputField);
